% internal_simpleMPC_solver_1 - a fast solver generated by FORCES PRO v3.0.0
%
%   OUTPUT = internal_simpleMPC_solver_1(PARAMS) solves a multistage problem
...
%
%   [OUTPUT, EXITFLAG] = internal_simpleMPC_solver_1(PARAMS) returns additionally
...
%    -100 - License error
%
%   [OUTPUT, EXITFLAG, INFO] = internal_simpleMPC_solver_1(PARAMS) returns 
