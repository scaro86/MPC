...
a Python wrapper for a fast solver generated by FORCES PRO v3.0.0
   ...
   subject to the parameters supplied in the following dictionary:
       PARAMS['p_1'] - column vector of length 2
...
#_lib = ctypes.CDLL(os.path.join(os.getcwd(),'internal_simpleMPC_solver_1/lib/internal_simpleMPC_solver_1.dll')) 
try:
	_lib = ctypes.CDLL(os.path.join(os.path.dirname(os.path.abspath(__file__)),'internal_simpleMPC_solver_1/lib/internal_simpleMPC_solver_1.dll'))
	csolver = getattr(_lib,'internal_simpleMPC_solver_1_solve')
except:
	_lib = ctypes.CDLL(os.path.join(os.path.dirname(os.path.abspath(__file__)),'internal_simpleMPC_solver_1/lib/libinternal_simpleMPC_solver_1.dll'))
	csolver = getattr(_lib,'internal_simpleMPC_solver_1_solve')
...
#	def from_param(self):
#		return self
	_fields_ = [('p_1', ctypes.c_double * 2),
]
