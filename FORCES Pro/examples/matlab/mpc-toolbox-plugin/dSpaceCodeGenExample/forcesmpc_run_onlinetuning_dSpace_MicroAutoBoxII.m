...
% 
% The Simulink block that is used as an MPC controller is the FORCES PRO
% solver block

% Copyright 1990-2020 The MathWorks, Inc and Embotech AG, Zurich, Switzerland  
...
%% Generate FORCES PRO sparse QP solver
