...
% shows how to do it with a FORCES PRO solver.
%
...
%%
% When the FORCES PRO QP solver converges to an optimal solution, the QP
...
% FORCES PRO detects the same infeasibility time period.
