% quadprog - a fast optimizer generated by FORCES PRO through Y2F
%
%   OUTPUT = quadprog(PARAMS) solves a multistage problem
...
%
%   [OUTPUT, EXITFLAG] = quadprog(PARAMS) returns additionally
...
%    -100 - License error
%
%   [OUTPUT, EXITFLAG, INFO] = quadprog(PARAMS) returns 
