% forces_quadprog - a fast optimizer generated by FORCES PRO through Y2F
%
%   OUTPUT = forces_quadprog(PARAMS) solves a multistage problem
...
%
%   [OUTPUT, EXITFLAG] = forces_quadprog(PARAMS) returns additionally
...
%    -100 - License error
%
%   [OUTPUT, EXITFLAG, INFO] = forces_quadprog(PARAMS) returns 
