% internal_quadprog_1 - a fast solver generated by FORCES PRO v3.0.0
%
%   OUTPUT = internal_quadprog_1(PARAMS) solves a multistage problem
...
%
%   [OUTPUT, EXITFLAG] = internal_quadprog_1(PARAMS) returns additionally
...
%    -100 - License error
%
%   [OUTPUT, EXITFLAG, INFO] = internal_quadprog_1(PARAMS) returns 
