...
a Python wrapper for a fast solver generated by FORCES PRO v3.0.0
   ...
   OUTPUT = internal_quadprog_1_py.internal_quadprog_1_solve(PARAMS) solves a multistage problem
   ...
   [OUTPUT, EXITFLAG] = internal_quadprog_1_py.internal_quadprog_1_solve(PARAMS) returns additionally
   ...
   [OUTPUT, EXITFLAG, INFO] = internal_quadprog_1_py.internal_quadprog_1_solve(PARAMS) returns 
...
#_lib = ctypes.CDLL(os.path.join(os.getcwd(),'internal_quadprog_1/lib/internal_quadprog_1.dll')) 
try:
	_lib = ctypes.CDLL(os.path.join(os.path.dirname(os.path.abspath(__file__)),'internal_quadprog_1/lib/internal_quadprog_1.dll'))
	csolver = getattr(_lib,'internal_quadprog_1_solve')
except:
	_lib = ctypes.CDLL(os.path.join(os.path.dirname(os.path.abspath(__file__)),'internal_quadprog_1/lib/libinternal_quadprog_1.dll'))
	csolver = getattr(_lib,'internal_quadprog_1_solve')

class internal_quadprog_1_params_ctypes(ctypes.Structure):
#	@classmethod
#	def from_param(self):
#		return self
...
internal_quadprog_1_params = {'p_1' : np.array([]),
}
params = {'p_1' : np.array([]),
}
internal_quadprog_1_params_types = {'p_1' : np.float64,
}

class internal_quadprog_1_outputs_ctypes(ctypes.Structure):
#	@classmethod
#	def from_param(self):
#		return self
...
internal_quadprog_1_outputs = {'o_1' : np.array([]),
'o_2' : np.array([]),
}


class internal_quadprog_1_info(ctypes.Structure):
#	@classmethod
#	def from_param(self):
#		return self
...
csolver.argtypes = ( ctypes.POINTER(internal_quadprog_1_params_ctypes), ctypes.POINTER(internal_quadprog_1_outputs_ctypes), ctypes.POINTER(internal_quadprog_1_info), ctypes.POINTER(FILE))
csolver.restype = ctypes.c_int

def internal_quadprog_1_solve(params_arg):
	'''
a Python wrapper for a fast solver generated by FORCES PRO v3.0.0
 ...
 See also COPYING
	...
	# convert parameters
	params_py = internal_quadprog_1_params_ctypes()
	for par in params_arg:
		try:
			#setattr(params_py, par, npct.as_ctypes(np.reshape(params_arg[par],np.size(params_arg[par]),order='A'))) 
			params_arg[par] = np.require(params_arg[par], dtype=internal_quadprog_1_params_types[par], requirements='F')
	...
	outputs_py = internal_quadprog_1_outputs_ctypes()
	info_py = internal_quadprog_1_info()
	if sys.version_info.major == 2:
		...
		try:
			PyFile_AsFile.restype = ctypes.POINTER(FILE)
			exitflag = _lib.internal_quadprog_1_solve( params_py, ctypes.byref(outputs_py), ctypes.byref(info_py), PyFile_AsFile(fp)  )
		...
		try:
			if sys.platform.startswith('win'):
				exitflag = _lib.internal_quadprog_1_solve( params_py, ctypes.byref(outputs_py), ctypes.byref(info_py), None )
			else:
				exitflag = _lib.internal_quadprog_1_solve( params_py, ctypes.byref(outputs_py), ctypes.byref(info_py), fp )
			libc.fclose(fp)
	...
	# convert outputs
	for out in internal_quadprog_1_outputs:
		internal_quadprog_1_outputs[out] = npct.as_array(getattr(outputs_py,out))

	return internal_quadprog_1_outputs,int(exitflag),info_py

solve = internal_quadprog_1_solve
