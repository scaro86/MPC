...
#define S_FUNCTION_NAME internal_forces_quadprog_1_simulinkBlock
...
typedef internal_forces_quadprog_1interface_float internal_forces_quadprog_1nmpc_float;
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	real_T *o_2 = (real_T*) ssGetOutputPortSignal(S,1);
	
	

	/* Solver data */
	internal_forces_quadprog_1_params params;
	internal_forces_quadprog_1_output output;
	internal_forces_quadprog_1_info info;	
    ...
    #if SET_PRINTLEVEL_internal_forces_quadprog_1 > 0
	...
	/* Call solver */
	exitflag = internal_forces_quadprog_1_solve(&params, &output, &info, fp );
